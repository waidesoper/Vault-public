...
public class EternalRenderer extends LivingRenderer<EternalEntity, EternalModel> {
    ...
    @Override
    protected void scale(EternalEntity entity, MatrixStack matrixStack, float partialTickTime) {
    ...
    private void setModelVisibilities(EternalEntity clientPlayer) {
        EternalModel playermodel = this.getModel();
    ...
    protected void renderNameTag(EternalEntity entityIn, ITextComponent displayNameIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    protected void setupRotations(EternalEntity entityLiving, MatrixStack matrixStack, float ageInTicks, float rotationYaw, float partialTicks) {
